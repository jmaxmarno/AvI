    ...
    constructor(data, category, yearGrid) {
      ...
      //story data
        ...
        this.points = {
          ...
          "aspect":[
            {"display":"May 2011","time":[{"year":"2011","months":[5]}],"text":"The distribution of the slope aspect in the observations of May 2011 looks quite different from most months. It appears that many more slides were reported on South and West facing slopes but it is hard to draw conclusions about this month because there were only five avalanche observations, making the proportions prone being effected by random chance."},
